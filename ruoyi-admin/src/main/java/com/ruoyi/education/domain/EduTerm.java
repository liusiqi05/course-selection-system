...
public class EduTerm extends BaseEntity
{
    ...
    public void setSelectionStart(Date selectionStart) 
    {
    ...
    public void setSelectionEnd(Date selectionEnd) 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("selectionStart", getSelectionStart())
            .append("selectionEnd", getSelectionEnd())
