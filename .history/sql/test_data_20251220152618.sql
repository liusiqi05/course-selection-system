...
-- ----------------------------
-- 更新/插入学期数据
UPDATE edu_term SET is_current = '0' WHERE term_id IN (1, 2);

INSERT IGNORE INTO edu_term(term_id, term_name, start_date, end_date, is_current, status, create_by, create_time, remark)
VALUES 
(3, '2025-2026学年第一学期', '2025-09-01', '2026-01-15', '1', '0', 'admin', NOW(), '秋季学期（当前）'),
(4, '2025-2026学年第二学期', '2026-02-16', '2026-07-04', '0', '0', 'admin', NOW(), '春季学期（待开放）');
