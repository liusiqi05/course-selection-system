  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20" style="margin-top: 20px;">
      ...
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="stat-card" shadow="hover">
          <div class="stat-content">
            <div class="stat-icon" style="background: linear-gradient(135deg, #36cfc9 0%, #13c2c2 100%);">
      ...
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="stat-card" shadow="hover">
          <div class="stat-content">
            <div class="stat-icon" style="background: linear-gradient(135deg, #597ef7 0%, #2f54eb 100%);">
      ...
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="stat-card" shadow="hover">
          <div class="stat-content">
            <div class="stat-icon" style="background: linear-gradient(135deg, #73d13d 0%, #52c41a 100%);">
...
export default {
  ...
  data() {
    return {
      ...
      teacherCount: 0,
      quickLinks: [
        { name: '学期管理', path: '/education/term', icon: 'el-icon-date', color: '#1890ff' },
        { name: '课程管理', path: '/education/course', icon: 'el-icon-notebook-2', color: '#13c2c2' },
        { name: '开课安排', path: '/education/opening', icon: 'el-icon-s-grid', color: '#2f54eb' },
        { name: '学生选课', path: '/education/enroll', icon: 'el-icon-edit-outline', color: '#1890ff' },
        { name: '学生信息', path: '/education/student', icon: 'el-icon-user', color: '#597ef7' },
        { name: '教师信息', path: '/education/teacher', icon: 'el-icon-s-custom', color: '#52c41a' }
      ],
      notices: [
