  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-divider content-position="left">选课时间设置</el-divider>
        <el-form-item label="选课开始" prop="selectionStart">
          <el-date-picker clearable
            v-model="form.selectionStart"
            type="datetime"
            value-format="yyyy-MM-dd HH:mm:ss"
            placeholder="请选择选课开始时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="选课结束" prop="selectionEnd">
          <el-date-picker clearable
            v-model="form.selectionEnd"
            type="datetime"
            value-format="yyyy-MM-dd HH:mm:ss"
